  ...
  return (
    <div className='flex items-center justify-between bg-white px-4 py-3 dark:bg-black'>
      ...
      <div className='flex items-center'>
        ...
        className={isDarkMode ? "rounded p-2 dark:bg-gray-700":"rounded p-2 hover:bg-gray-100"}>
          {
            !isDarkMode ? (
         ...
         <Link href="/settings" className='h-min rounded p-2 hover:bg-gray-100'>
            <Settings className={isDarkMode ? "h-min w-min rounded p-2 dark:bg-gray-700":"h-min w-min  rounded p-2 hover:bg-gray-100"}/>
         </Link>
