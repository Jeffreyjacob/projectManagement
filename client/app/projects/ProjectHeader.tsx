...
function ProjectHeader({activeTab,setActiveTab}: Props) {
  ...
  return (
    <div className=" px-4 xl:px-6">
       <ModelNewProject isOpen={isModelNewProjectOpen} 
      ...
      <div className=" flex flex-wrap-reverse gap-2 border-y border-gray-200 pb-[8px] pt-2 dark:border-stroke-dark md:items-center ">
         <div className="flex flex-1 items-center gap-2 md:gap-4">
           <TabButton name="Board" icon= {<Grid3X3 className="h-5 w-5"/>}
            setActiveTab={setActiveTab} activeTab={activeTab}/>
             <TabButton name="List" icon= {<List className="h-5 w-5"/>}
            setActiveTab={setActiveTab} activeTab={activeTab}/>
             <TabButton name="Timeline" icon= {<Clock className="h-5 w-5"/>}
            setActiveTab={setActiveTab} activeTab={activeTab}/>
         ...
         <div className="flex items-center gap-2">
            ...
            <div className="relative ">
              ...
              className="rounded-md border py-1 pl-10 pr-4 focus:outline-none dark:border-dark-secondary dark:text-white"/>
...
const TabButton = ({name,icon,setActiveTab,activeTab}:TabButtonProps)=>{
    ...
    return (
        <button
         className={`relative flex items-center gap-2 px-1 py-1 text-gray-500 after:absolute 
         after:-bottom-[9px] after:left-0  after:h-[1px] after:w-full hover:text-blue-600
          dark:hover:text-white sm:px-2 lg:px-4 ${
